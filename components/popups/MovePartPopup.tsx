 ...
 * 파트이동 팝업 컴포넌트
 *
 * @description ReceptionCheckInButton의 C153 "파트이동" 클릭 시 표시되는 팝업
 * @component
 */
export default function MovePartPopup({ isOpen, onClose }: MovePartPopupProps) {
  return (
    <Popup isOpen={isOpen} onClose={onClose}>
      <>
        <PopupSectionBox x={260} y={20} width={1400}>
          <PopupHeader title="파트이동" onClose={onClose} />
        </PopupSectionBox>
